...
namespace YTech.IM.Sense.Web.Controllers.Transaction
{
   public partial class InventoryController
   {
       ...
       private void UpdateStock(DateTime? transDate, string transDesc, string transStatus,MItem itemId, decimal? price,decimal? qty, TTransDet det, bool addStock, MWarehouse mWarehouse)
       {
           if (addStock)
           {
